...
const SeasonRentalForm: React.FC<SeasonRentalFormProps> = ({
  ...
  const getSeasonDisplayInfo = (seasonKey: string) => {
    const seasonLabels: { [key: string]: { displayName: string; duration: number; months: string } } = {
      'sep_may': { displayName: 'Septiembre a Mayo', duration: 9, months: 'Septiembre a Mayo' },
      'sep_jun': { displayName: 'Septiembre a Junio', duration: 10, months: 'Septiembre a Junio' },
      'sep_jul': { displayName: 'Septiembre a Julio', duration: 11, months: 'Septiembre a Julio' },
      'oct_jun': { displayName: 'Octubre a Junio', duration: 9, months: 'Octubre a Junio' },
      'oct_jul': { displayName: 'Octubre a Julio', duration: 10, months: 'Octubre a Julio' },
      'oct_may': { displayName: 'Octubre a Mayo', duration: 8, months: 'Octubre a Mayo' },
      'nov_aug': { displayName: 'Noviembre a Agosto', duration: 10, months: 'Noviembre a Agosto' },
      'dec_sep': { displayName: 'Diciembre a Septiembre', duration: 10, months: 'Diciembre a Septiembre' },
      'jan_oct': { displayName: 'Enero a Octubre', duration: 10, months: 'Enero a Octubre' },
      'feb_nov': { displayName: 'Febrero a Noviembre', duration: 10, months: 'Febrero a Noviembre' },
      'mar_dec': { displayName: 'Marzo a Diciembre', duration: 10, months: 'Marzo a Diciembre' },
      'apr_jan': { displayName: 'Abril a Enero', duration: 10, months: 'Abril a Enero' },
      'may_feb': { displayName: 'Mayo a Febrero', duration: 10, months: 'Mayo a Febrero' },
      'jun_mar': { displayName: 'Junio a Marzo', duration: 10, months: 'Junio a Marzo' },
      'jul_apr': { displayName: 'Julio a Abril', duration: 10, months: 'Julio a Abril' },
      'aug_may': { displayName: 'Agosto a Mayo', duration: 10, months: 'Agosto a Mayo' },
      'pct_mayo': { displayName: 'Octubre a Mayo', duration: 8, months: 'Octubre a Mayo' },
