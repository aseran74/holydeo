...
import { Link } from "react-router-dom"; // Corregido: 'react-router-dom' es el paquete correcto
      ...
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-3 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <Link to="/" className="flex items-center transition-transform duration-200 hover:scale-105">
            <img className="dark:hidden h-9 w-auto max-w-[140px] object-contain" src="/logotrans.svg" alt="CHISREACT Logo" />
            <img className="hidden dark:block h-9 w-auto max-w-[140px] object-contain" src="/logotrans-white.svg" alt="CHISREACT Logo" />
          </Link>
          
          {/* CAMBIO: Se ha eliminado el segundo bloque del logo que era redundante */}
        ...
        <div className={`${isApplicationMenuOpen ? "flex" : "hidden"} items-center justify-between w-full gap-4 px-5 py-4 lg:flex shadow-md lg:justify-end lg:px-0 lg:shadow-none`}>
